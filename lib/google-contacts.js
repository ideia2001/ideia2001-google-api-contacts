...
GoogleContacts.prototype.getContacts = function (options, callback) {
    ...
    var requestOptions = {
        ...
        qs: options.query_params ? lodash.defaults({}, DEFAULT_QUERY_PARAMS, options.query_params) : DEFAULT_QUERY_PARAMS
    };
 ...
 * @param {number} options.phone Phone Id.
...
GoogleContacts.prototype.addContact = function (options, callback) {
    ...
    var bodyContent = createContactXml.getXml();
    var requestOptions = {
        uri: GOOGLE_CONTACTS_URI,
        method: "POST",
